...
function slider({container, slide, nextArrow, prevArrow, totalCounter, currentCounter, wrapper, field}){
    ...
    next.addEventListener('click', ()=>{
        if(offset === transformToDigits(width) * (slides.length - 1)){
            offset = 0;
        } else{
            offset += transformToDigits(width);
        }
    ...
    prev.addEventListener('click', ()=>{
        if(offset === 0){
            offset = transformToDigits(width) * (slides.length - 1);
        } else{
            offset -= transformToDigits(width);
        }
    ...
    dots.forEach(dot =>{
        dot.addEventListener('click', e =>{
            ...
            slideIndex = +slideTo;
            offset = +transformToDigits(width) * (slideTo - 1);
    ...
    function transformToDigits(string){
...
window.addEventListener('DOMContentLoaded', ()=>{
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2024-05-21');
